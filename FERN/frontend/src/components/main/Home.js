  ...
  >
    ...
    <div data-draggable="true" style={{ position: "relative" }} draggable="false" className="">
      ...
      <div className="row gx-lg-5">
        ...
        <div className="col-lg-8 mx-auto mb-4 mb-lg-0">
          <div className="card">
            <div
            ...
            >
              <img
                src="https://res.cloudinary.com/practicaldev/image/fetch/s--ej2MNlGS--/c_imagga_scale,f_auto,fl_progressive,h_900,q_auto,w_1600/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/wl1vrgmleuwhoyx0fuez.png"
                className="img-fluid"
                alt=""
                aria-controls="#picker-editor"
                draggable="false"
            ...
            <div className="card-body">
              <h5 className="card-title">FERN Stack</h5>
